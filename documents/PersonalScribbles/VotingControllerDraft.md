...
- [Key & Unique Design Components](#key--unique-design-components)
- [Verifiers and Subsidies](#verifiers-and-subsidies)
- [Voters and Rewards](#voters-and-rewards)
- [1. Contract Overview](#1-contract-overview)
  - [Dual-accounting Model](#dual-accounting-model-mappings)
  - [Voting and Claiming](#voting)
- [2. Design Choices](#2-design-choices)
  - [Rewards & Subsidies Distribution](#rewards--subsidies-optimal-distribution)
  - [Residuals Management](#residuals-accounting-and-recovery)
  - [Delegate Fee Tracking](#accurate-delegate-fee-application-intentional-historical-tracking)
- [3. Contract Functions](#3-contract-functions-walkthrough)
- [4. Execution Flow](#4-execution-flow)
- [5. Risk Management](#5-risk)
- [Upgrade Architecture](#upgrade-architecture)
- [Appendix](#appendix)
  - [Residuals Illustrated](#residuals-illustrated)
  - [Delegate Fee Implementation](#delegate-fee-tracking-for-proper-claiming)
  - [Reference Code](#other-reference-code)
