...
**`selectRedemptionOption(uint256 redemptionOption, uint256 redemptionAmount, uint256 minExpectedReceivable)`**
...
- `minExpectedReceivable` protects against fee changes between transaction submission and execution
...
8. **Slippage Protection**: `minExpectedReceivable` parameter protects users from fee changes between transaction submission and execution
