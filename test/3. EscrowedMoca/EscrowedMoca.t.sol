...
abstract contract StateT0_UsersScheduleTheirRedemptions is StateT0_RedemptionOptionsSet {
    ...
    function setUp() public virtual override {
        ...
        vm.startPrank(user1);
            esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption1, user1Amount / 2);
        vm.stopPrank();
        ...
        vm.startPrank(user2);
            esMoca.selectRedemptionOption(redemptionOption2_60Days, expectedOption2, user2Amount);
        vm.stopPrank();
    }
}
...
contract StateT0_UsersScheduleTheirRedemptions_Test is StateT0_UsersScheduleTheirRedemptions {
    ...
    // --------- negative tests: selectRedemptionOption() ---------
        ...
        function testRevert_UserCannot_SelectRedemptionOption_WhenAmountsAreZero() public {
            ...
            vm.startPrank(user1);
                vm.expectRevert(Errors.InvalidAmount.selector);
                esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption1, 0);
            vm.stopPrank();
        }
        ...
        function testRevert_UserCannot_SelectRedemptionOption_WhenAmountIsGreaterThanBalance() public {
            ...
            esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption1, user1Amount + 1);
            vm.stopPrank();
        }
        ...
        function testRevert_UserCannot_SelectRedemptionOption_WhenAmountIsGreaterThanTotalSupply() public {
            ...
            esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption1, 10 ether);
            vm.stopPrank();
        }
        ...
        function testRevert_UserCannot_SelectRedemptionOption_WhenRedemptionOptionIsDisabled() public {
            ...
            esMoca.selectRedemptionOption(5, expectedOption, user1Amount/2);
            vm.stopPrank();
        }
        ...
        function testRevert_RedemptionOptionInput_DoesNotMatchOptionInStorage() public {
            ...
            vm.startPrank(user1);
              ...
              esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption, user1Amount/2);
            vm.stopPrank();
            ...
            vm.startPrank(user1);
              vm.expectRevert(Errors.InvalidRedemptionOption.selector);
              esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption2, user1Amount/2);
            vm.stopPrank();
        }
    ...
    // --------- positive test: claimRedemptions() for instant redemption ---------
        ...
        function test_User3Can_SelectRedemptionOptionInstant_ReceivesMocaImmediately() public {
            ...
            // Execute instant redemption
            {
                ...
                // Execute
                vm.prank(user3);
                esMoca.selectRedemptionOption(redemptionOption3_Instant, expectedOption, instantRedeemAmount);
    ...
    // --------- positive test: claimRedemptions() for multiple timestamps ---------
        ...
        function test_User1Can_ClaimRedemptions_MultipleTimestamps() public {
            ...
            vm.startPrank(user1);
                esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption, amountForRedemption);
...
contract StateT60Days_DisableRedemptionOption_Test is StateT60Days_DisableRedemptionOption {
    ...
    // --------- negative tests: selectRedemptionOption() ---------
        ...
        function testRevert_UserCannot_SelectRedemptionOption() public {
            ...
            vm.startPrank(user1);
            vm.expectRevert(Errors.RedemptionOptionAlreadyDisabled.selector);
            esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption, user1Amount/4);
            vm.stopPrank();
        }
    ...
    // --------- positive tests: selectRedemptionOption() ---------
        function test_User1Can_SelectRedemptionOption1_30Days() public {
            ...
            // Execute redemption
            {
                ...
                vm.prank(user1);
                esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption, amount);
...
abstract contract StateT60Days_SetWhitelistStatus is StateT60Days_EnableRedemptionOption {
    function setUp() public virtual override {
       ...
       vm.startPrank(user1);
            esMoca.selectRedemptionOption(redemptionOption1_30Days, expectedOption, redemptionAmount); // 10% of user1's balance
        vm.stopPrank();
    }
}
...
contract StateT60Days_Paused_Test is StateT60Days_Paused {
    ...
    // --------- negative tests: normal functions cannot be called when contract is paused ---------
        ...
        function testRevert_UserCannot_SelectRedemptionOption_WhenPaused() public {
            ...
            vm.startPrank(user1);
            vm.expectRevert(Pausable.EnforcedPause.selector);
            esMoca.selectRedemptionOption(redemptionOption2_60Days, expectedOption, 50 ether);
            vm.stopPrank();
        }
